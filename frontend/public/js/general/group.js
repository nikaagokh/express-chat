...
export class Group {
    constructor(conversationId, chatName) {
    ...
    listeners() {
        ...
        this.optionsButton.addEventListener('click', () => {
            this.overlayService.openChatInfo(this.chatHeader, this.conversationId);
        })
              ...
              <div class="chat-container" id="main-container">
                <div class="chat-wrapper" id="chat-cont">
                 <div class="chat-header">
                   ...
                   <span class="chat-header-title">${this.chatName}</span>
